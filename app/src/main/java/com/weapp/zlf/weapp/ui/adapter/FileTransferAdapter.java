    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (file != null) {
            ...
            if (file.percent >= 100) {
                ...
                holder.file_trans_speed.setTextColor(context.getResources().getColor(R.color.colorPrimary));
            } else {
                holder.trans_progress.setVisibility(View.VISIBLE);
                if (file.percent == 0) {
                    holder.file_trans_speed.setText(context.getString(R.string.file_wait));
                    holder.file_trans_speed.setTextColor(context.getResources().getColor(R.color.colorAccent));
                }
            }
        }
