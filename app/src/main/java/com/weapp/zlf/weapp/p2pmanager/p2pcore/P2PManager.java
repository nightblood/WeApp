package com.weapp.zlf.weapp.p2pmanager.p2pcore;
...
import com.weapp.zlf.weapp.p2pmanager.p2pentity.param.ParamReceiveFiles;
import com.weapp.zlf.weapp.p2pmanager.p2pentity.param.ParamSendFiles;
import com.weapp.zlf.weapp.p2pmanager.p2pentity.param.ParamTCPNotify;
...
//        String[] typeStr = {"Database1", "Picture1"};
        return type == 0 ? Constant.DB_DIRS[1] : Constant.PHOTO_DIRS[1];
//        return Constant.PHOTO_DIRS[1] + File.separator + typeStr[type];
            ...
            switch (msg.what) {
                ...
                case P2PConstant.CommandNum.SEND_ABORT_SELF: //通知接收者，发送者退出了
                    if (manager.receiveFile_callback != null) {
                        ...
                        if (paramIPMsg != null)
                            manager.receiveFile_callback.AbortReceiving(P2PConstant.CommandNum.SEND_ABORT_SELF,
